...
interface CompoundNodeModalProps {
  nodes: Node[];
  edges: Edge[];
  open: boolean;
...
export default function CompoundNodeModal({
  nodes,
  edges,
  open,
  onOpenChange,
  onSave,
}: CompoundNodeModalProps) {
  // Basic info state
  const [name, setName] = useState("My Compound Node");
  ...
  const handleSave = () => {
    ...
    try {
      ...
      console.error("[CompoundNodeModal] Failed to save:", error);
      toast({
        title: "Save Failed",
        description:
          error instanceof Error ? error.message : "Failed to save compound node",
        variant: "destructive",
      });
    }
  };
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-3xl max-h-[85vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>Create Compound Node</DialogTitle>
          <DialogDescription>
            Save this workflow as a reusable node with simplified controls
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  placeholder="My Compound Node"
                />
              </div>

              <div className="space-y-2">
                <Label htmlFor="compound-icon">Icon</Label>
                <Select value={icon} onValueChange={setIcon}>
                  <SelectTrigger id="compound-icon">
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent>
            ...
            <div className="space-y-2">
              <Label htmlFor="compound-description">Description</Label>
              <Input
          ...
          <div className="space-y-3">
            <div>
              ...
              <p className="text-xs text-muted-foreground">
                Select which inputs become connection points (left side)
              </p>
            </div>
          ...
          <div className="space-y-3">
            <div>
              ...
              <p className="text-xs text-muted-foreground">
                Select parameters to expose as sliders/dropdowns on the node
              </p>
            </div>
          ...
          <div className="space-y-3">
            <div>
              ...
              <p className="text-xs text-muted-foreground">
                Select outputs to expose (right side) - at least one required
              </p>
            </div>
